...
const Success = ({route, navigation}) => {
  ...
  return (
    <>
      <Screen>
        <Text style={tw`text-[${color.blue}] mx-auto text-2xl my-4`}>
          Created Successfully !
        </Text>
        <View
          style={tw`flex-row mb-3 rounded-xl items-center justify-center bg-gray-300 h-[400px] pl-3 w-[94%] mx-auto`}>
          ...
          <View style={tw`flex gap-4   w-[70%]  `}>
            ...
            <Text style={tw`text-xl text-gray-700 `}>{password}</Text>
